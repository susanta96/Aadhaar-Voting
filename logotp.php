                                ...
                                <div class="timer-title">
                                    <h2>
                                      ...
                                      <span>An OTP is send to your mobile no & mail address</span>
                  								...
                  								<form role="form" action="src/php/logotp/otpprocess.php" method="post" onsubmit= "return validation()">
                                    <div class="modal-body">
                                          ...
                                          <span id="otp" class="text-danger font-weight-bold"> </span>
                            						...
                            						<a class="btn-buy-token btn-round btn-gradient" href="src/php/logotp/process.php">Resend</a>
