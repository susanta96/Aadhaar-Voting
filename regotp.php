                                ...
                                <div class="timer-title">
                                    <h2>
                                       ...
                                       <span>An OTP is send to your mobile no & mail address</span>
                  								...
                  								<form role="form" action="src/php/regotp/otpprocess.php" method="post" onsubmit= "return validation()">
                                    <div class="modal-body">
                                          ...
                                          <a class="btn-buy-token btn-round btn-gradient" href="src/php/regotp/process.php">Resend</a>
	  ...
	  function validation(){
		  ...
		  if( otpvalue == "" ){
			...
			if(( aadhaarnumber.length!=4 ){
				document.getElementById('otp').innerHTML = "  The Otp must be 4 digits";
				return false;
			}
      if(isNaN(otpvalue)){
